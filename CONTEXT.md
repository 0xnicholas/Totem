...
**Execution Boundary**:
The single orchestration point (`executeAction`) through which every action call passes: schema validation, allowlist check, token acquisition, dispatch, audit write. The primary test seam (Seam A).
