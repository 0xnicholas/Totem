...
function toMetadata(action: Action): { name: string; description: string; effects: string } {
  return { name: action.name, description: action.description, effects: action.effects };
}
